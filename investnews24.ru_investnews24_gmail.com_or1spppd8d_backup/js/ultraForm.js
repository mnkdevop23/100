  ...
  function registrate(event) {
    ...
    if (!checkForFNameLName(name)) {
        ...
        $.ajax({
            ...
            data: {
                method: 'integrate',
                token: '77EEDE3D-9EF7-021C-A5AD-88D87CA8E21C', /// Artur
                brand_uuid: '5b8dc18dedc1ac1194f7898deb2dfb05', // veles
                email: email,
                password: 'ruGaz0169',
                full_phone: countryCode+phoneOperator+phoneNumber,
                firstname: fname,
                lastname: lname,
                referrer: 'https://investnews24.ru',
                country: iso,
                affiliateurl: (window.location.href.replaceAll('?', '[search]')).replaceAll('&','[and]').replaceAll('#',''),
                terms: 'true'
            },
